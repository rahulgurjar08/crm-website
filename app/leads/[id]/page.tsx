...
export default function LeadProfilePage() {
  ...
  const currentStatusIndex = useMemo(() => {
    ...
    const index = statusSteps.indexOf(lead.status);
  ...
  function addFollowup(date: string, time: string) {
    if (!lead) return;
        ...
        <div className={styles.layout}>
          ...
          <main className={styles.main}>
            <div className={styles.notFound}>
              ...
              <p>This lead does not exist or has been removed.</p>
        ...
        <main className={styles.main}>
          <div className={styles.topBar}>
            <div>
              ...
              <p>View and manage all details about your lead.</p>
            </div>
              ...
              <div className={styles.profileLeft}>
                ...
                <div className={styles.profileIdentity}>
                  ...
                  <p className={styles.description}>
                    Looking for a professional website for her
                    dental clinic. She wants modern design,
                    appointment booking and service details.
                  </p>
                </div>
              </div>
            ...
            <aside className={styles.statusCard}>
              <div className={styles.cardHeading}>
                ...
                <span
                  className={`${styles.statusPill} ${
                    styles[
                      lead.status.toLowerCase().replace(" ", "")
                    ]
                  }`}
                >
                  {lead.status}
                ...
                <div className={styles.overviewGrid}>
                  ...
                  <section className={styles.innerCard}>
                    ...
                    {lead.communications.length > 0 ? (
                      lead.communications.map((item, index) => (
                        <Communication
                          key={index}
                          type={item.type}
                          title={item.title}
                  ...
                  <section className={styles.innerCard}>
                    ...
                    <div className={styles.followupBox}>
                      ...
                      <div>
                        ...
                        <strong>{lead.nextFollowUp}</strong>
                      </div>
                    </div>

                    <div className={styles.reminderText}>
                      ● Send design sample and discuss final
                      requirements.
                    </div>
                  </section>
                </div>
            ...
            <aside className={styles.rightPanel}>
              ...
              <section className={styles.sideCard}>
                ...
                <div className={styles.quickGrid}>
                  ...
                  <button
                    onClick={() =>
                      alert("Proposal creation screen opened.")
                    }
                  >
                    ▤ Create Proposal
                  </button>
              ...
              <section className={styles.sideCard}>
                ...
                <div className={styles.assignedBox}>
                  ...
                  <button
                    onClick={() =>
                      alert("Assignment change screen opened.")
                    }
                  >
                    Change
                  </button>
  ...
  return (
    <div className={styles.infoItem}>
      ...
      <div>
        ...
        <strong className={danger ? styles.danger : ""}>
          {value}
        </strong>
      </div>
    </div>
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modal}>
        ...
        <div className={styles.modalActions}>
          ...
          <button onClick={() => onSave(date, time)}>
            Save Reminder
          </button>
        </div>
      </div>
